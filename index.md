...
<section class="hero">
  ...
  <h1>JobMonkeyGO</h1>
  <p class="tagline">The easiest way to get tasks and errands done quickly in Hong&nbsp;Kong.</p>
  <div class="download-buttons">
    <a href="#" class="badge-btn badge-apple" aria-label="Download on the App Store">
      ...
      <div class="badge-btn-inner">
        <span class="badge-btn-sub">Download on the</span>
        App Store
      </div>
    </a>
    <a href="#" class="badge-btn badge-google" aria-label="Get it on Google Play">
      ...
      <div class="badge-btn-inner">
        <span class="badge-btn-sub">Get it on</span>
        Google Play
      </div>
    </a>
  </div>
...
<section class="screenshot">
  <img src="assets/img/mockup.png" alt="JobMonkeyGO app screenshot">
</section>
